...
const AboutUs = () => {
    ...
    return (
        <section>
            <div id="WhoWeAre" className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 ">
                <div className="space-y-5 max-w-5xl mx-auto text-center">
                    <div className="flex flex-wrap items-center justify-center gap-6 xl:justify-center">
                        {
                    ...
                    <div className="items-center justify-center mx-auto gap-x-3 space-y-3 sm:flex sm:space-y-0 xl:justify-center">
